...
const faqs = [
  ...
  },
  {
    ...
    a: 'Families turn to respite care for many different reasons: a caregiver needs a break to rest and recharge; a caregiver is going on vacation or recovering from an illness or surgery; a temporary gap exists in regular caregiving arrangements; families want their loved one to "try out" assisted living before deciding on a longer-term move; or seasonal isolation, when families want their loved one to enjoy companionship and social engagement. Whatever the reason, our team is here to provide compassionate support and peace of mind.',
  },
  {
