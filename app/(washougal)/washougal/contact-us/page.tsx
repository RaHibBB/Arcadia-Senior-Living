...
import WashougalContactForm from './WashougalContactForm'

export const metadata: Metadata = {
  title: 'Contact Us | Arcadia Senior Living Washougal, WA',
  description: 'Contact Arcadia Senior Living Lookout Ridge in Washougal, WA for pricing, availability, tours, and more. Call (360) 335-1238 or fill out our contact form.',
  alternates: { canonical: 'https://arcadiaretirement.com/washougal/contact-us' },
  openGraph: {
    title: 'Contact Us | Arcadia Senior Living Washougal',
    description: 'Get in touch with Arcadia Senior Living Lookout Ridge in Washougal, WA. Call (360) 335-1238.',
    images: [{ url: '/images/washougal-exterior.jpg', width: 1200, height: 630 }],
  },
}

export default function WashougalContactPage() {
  return (
    <main>
      ...
      <section className="relative min-h-[300px] md:min-h-[360px] flex items-center bg-[#2d5a5c] overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[1100px] mx-auto px-6 lg:px-8 py-16">
          <p className="text-white/70 text-sm uppercase tracking-[0.4em] mb-3">Washougal, Washington</p>
      ...
      <section className="bg-[#2d5a5c]">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10">
            <a href="tel:+13603351238" className="flex items-center gap-4 px-6 py-5 hover:bg-white/5 transition-colors group">
              ...
              <div>
                ...
                <p className="text-white font-medium">(360) 335-1238</p>
              </div>
            </a>
            <div className="flex items-center gap-4 px-6 py-5">
              ...
              <div>
                ...
                <p className="text-white font-medium">2300 W 9th St, Washougal, WA</p>
              </div>
            </div>
            <div className="flex items-center gap-4 px-6 py-5">
              <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center shrink-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-10 items-start">
            ...
            <div className="bg-white shadow-sm p-8 md:p-10">
              <div className="mb-8">
                ...
                <h2 className="font-serif text-2xl md:text-3xl text-[#1a1a1a] leading-snug">
                  Thank you so much for your interest in Arcadia!
                </h2>
              </div>
              <WashougalContactForm />
            </div>
            ...
            <div className="space-y-6 lg:sticky lg:top-28">
              ...
              <div className="bg-white shadow-sm overflow-hidden">
                <img
                  src="/images/washougal-exterior.jpg"
                  alt="Arcadia Senior Living Washougal exterior"
                  className="w-full h-44 object-cover"
                />
                <div className="p-6">
                  <h3 className="font-serif text-lg text-[#2d5a5c] mb-4">
                    Arcadia Senior Living Lookout Ridge
                  </h3>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <a href="https://maps.app.goo.gl/m57wfQGeJYyYFKsL6" target="_blank" rel="noopener noreferrer"
                        ...
                        2300 W 9th St<br />Washougal, WA 98671
                      </a>
                    </li>
                    <li className="flex items-center gap-3">
                      ...
                      <a href="tel:+13603351238" className="text-sm text-[#555] hover:text-[#c06448] transition-colors">
                        (360) 335-1238
                      </a>
                    </li>
                  </ul>
              ...
              <div className="bg-white shadow-sm p-6">
                <svg className="w-8 h-8 text-[#c06448]/30 mb-3" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/>
                </svg>
                <p className="text-[#555] text-sm leading-relaxed italic mb-4">
                ...
                <div>
                  <p className="text-[#2d5a5c] text-sm font-semibold">Scott Greenwood</p>
                  <p className="text-[#888] text-xs">Child of resident</p>
                </div>
              </div>
              ...
              <div className="bg-[#2d5a5c] p-6 text-center">
                ...
                <p className="text-white/70 text-sm mb-5 leading-relaxed">
                  Experience Arcadia Lookout Ridge firsthand. Schedule a personal tour of our community.
                </p>
