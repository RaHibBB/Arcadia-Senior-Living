  ...
  return (
    <footer className="bg-[#2d5a5c] text-white">
      ...
      <div className="max-w-[1340px] mx-auto px-6 lg:px-10 py-8 flex items-center justify-between flex-wrap gap-4">
        <Link href="/portland">
          <Image
            src="/images/arcadia-portland-logo-white.png"
            width={280}
            height={65}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="space-y-3">
              {[
                ...
                { label: 'News & Events', href: '/portland/news-events' },
            ...
            <div className="flex items-center gap-5">
              ...
              <a href="https://www.droregon.org/disability-rights-oregon-resources/fair-housing-handbook-reasonable-accommodations-modifications" target="_blank" rel="noopener noreferrer" title="Disability Rights Oregon" className="text-white/50 hover:text-white transition-colors">
                <svg className="w-6 h-6 fill-current" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M496.101 385.669l14.227 28.663c3.929 7.915.697 17.516-7.218 21.445l-65.465 32.886c-3.578 1.796-6.842 2.487-9.988 2.487-5.701 0-11.032-2.700-14.209-7.753-51.732-83.096-88.573-127.826-160.468-127.826h-1.469l-9.748 22.075c9.686 2.810 16.773 11.872 16.773 22.726v128c0 13.255-10.745 24-24 24H152c-13.255 0-24-10.745-24-24V380.372c0-13.255 10.745-24 24-24H288V320c-32.250 0-64-5.500-83.072-24.572L184 272c-8.284-8.284-8.284-21.716 0-30l41.373-41.373C236.246 189.754 256 192 256 192c61.260 0 110.750-49.740 110.750-111C366.750 19.740 317.260 0 256 0 194.740 0 145.250 49.740 145.250 111c0 40.734 21.965 76.474 54.750 96.004L144 320 48 416 0 368l96-96L147.016 248.972c-5.578-10.990-8.766-23.373-8.766-36.520C138.250 94.010 192.238 0 256 0s117.750 80.010 117.750 176c0 74.258-46.382 137.982-112.010 163.210 51.030 13.820 87.070 49.860 134.361 46.459z"/></svg>
              </a>
          ...
          <div className="text-center md:border-x md:border-white/10 md:px-10">
            ...
            <p className="text-white/75 text-base leading-relaxed">
              Arcadia Senior Living Portland is part of the Arcadia Senior Living Communities providing assisted living and respite services to our amazing residents.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-5 md:items-end">
            <ul className="space-y-4">
              <li>
                <a href="tel:+15032068930" className="flex items-center gap-3 text-base text-white/80 hover:text-white transition-colors md:justify-end">
                  ...
                  Call 24/7 – <strong className="text-white ml-1">(503) 206-8930</strong>
                </a>
              </li>
              <li>
                <a href="https://maps.app.goo.gl/xUKjKEMHAnT2w2HJ6" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-base text-white/80 hover:text-white transition-colors md:justify-end">
                  ...
                  13031 SE Foster Rd, Portland, OR
                </a>
              </li>
            </ul>

            <div className="flex items-center gap-4 text-base text-white/60 md:justify-end">
              ...
              <a href="https://arcadiaretirement.com/portland/sitemap.xml" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors hover:underline underline-offset-2">Site Map</a>
            </div>
          </div>
