...
const navLinks = [
  {
    ...
    href: '#',
    children: [
      { label: 'Assisted Living', href: '/portland/assisted-living' },
      { label: 'Respite Care',    href: '/portland/respite-care' },
    ],
  },
  { label: 'Activities & Amenities', href: '/portland#Amenities' },
  { label: 'Floor Plans',            href: '/portland/floor-plans' },
  { label: 'Pricing',                href: '/portland#pricing' },
  { label: 'Photos',                 href: '/portland/photos' },
  { label: 'Contact',                href: '/portland/contact-us' },
]
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-[1340px] mx-auto px-8">
          <div className="flex items-center justify-between h-[76px] gap-8">
            ...
            {/* Logo */}
            <Link href="/portland" className="flex-shrink-0 py-2">
              <Image
                src="/images/arcadia-portland-logo.png"
                width={260} height={60}
              ...
              {navLinks.map(link => (
                link.children ? (
                  ...
                  >
                    ...
                    {/* Dropdown with pt bridge to prevent gap */}
        ...
        {mobileOpen && (
          <div className="lg:hidden bg-white border-t border-gray-100 shadow-xl">
            ...
            <div className="sm:hidden flex items-center gap-2 px-6 py-4 bg-[#2d5a5c]">
              ...
              <a href="tel:+15032068930" className="text-white font-bold text-base">(503) 206-8930</a>
            </div>
            <nav className="px-6 py-2">
              {/* Service group */}
              <div className="border-b border-gray-100">
                <p className="py-2 text-xs uppercase tracking-widest text-gray-400 font-semibold mt-2">Services</p>
                <Link href="/portland/assisted-living" className="block py-3 text-base text-[#333] font-medium hover:text-[#2d5a5c] transition-colors pl-3 border-l-2 border-transparent hover:border-[#2d5a5c]" onClick={() => setMobileOpen(false)}>
                  Assisted Living
                </Link>
                <Link href="/portland/respite-care" className="block py-3 text-base text-[#333] font-medium hover:text-[#2d5a5c] transition-colors pl-3 border-l-2 border-transparent hover:border-[#2d5a5c]" onClick={() => setMobileOpen(false)}>
                  Respite Care
                </Link>
              </div>
              {/* Other links */}
